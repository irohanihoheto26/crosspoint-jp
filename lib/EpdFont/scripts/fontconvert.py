...
parser.add_argument("--no-default-intervals", dest="no_default_intervals", action="store_true", help="Export only the code points given by --additional-intervals (skip the built-in Latin/Cyrillic/... intervals). Useful for tiny special-purpose fonts such as large numerals.")
